...
<script>
    ...
    <div class="main_body col-9">
        ...
        <section id="main-form">
            ...
            <h2 class="text-center text-danger pt-3 font-weight-bold">teacher management system</h2>
            <div class="container bg-danger" id="formsetting">
               ...
               <?php
                    if(isset($_GET['edit_teacher'])){
                        ...
                        $query="select * from teacher_detail where t_id='$edit_t_id';";
                ...
                <div class="row">
                    <div class="col-md-5 col-sm-5 col-12 m-auto">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="qualification" placeholder="Enter your Qualification" class="form-control" required="required" value="<?php echo $row['qualification']; ?>">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-5 col-sm-5 col-12 m-auto">
                        ...
                        <div class="input-group">
                            <label class="text-white">teacher Photo</label>
...
if(isset($_POST['update'])){
        ...
        $image_query="select * from teacher_detail where t_id = '$edit_t_id';";
        ...
        if(($image_type!= "image/jpeg") or ($image_type != "image/png")){
            ...
            $sql="update teacher_detail set fname='$fname', lname='$lname', email='$email',qualification='$qual', birthdate='$birthdate',gender='$gender',mobile='$mobile',city='$city',district='$district',state='$state',nation='$nationality',photo='$image' where t_id='$edit_t_id';";
